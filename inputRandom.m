function [N, Adj,CI, F, A, B, C] = InputMan(N, Adj, CI, F, A, B, C)
    ...
    Symmetrylabel = uicontrol('Style', 'text', 'String', 'Choose Symmetry:', 'Position', [10, 325, 280, 20]);
    Symmetry = uicontrol('Style', 'edit', 'Position', [10, 300, 280, 30],'String',mat2str(Adj));

    selflooplabel = uicontrol('Style', 'text', 'String', 'Choose Selfloop:', 'Position', [10, 275, 280, 20]);
    selfloop = uicontrol('Style', 'edit', 'Position', [10, 250, 280, 30],'String',mat2str(CI));
